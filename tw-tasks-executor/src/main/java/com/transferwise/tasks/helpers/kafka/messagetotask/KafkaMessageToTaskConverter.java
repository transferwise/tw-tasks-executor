...
public class KafkaMessageToTaskConverter<T> implements IKafkaMessageHandler<String> {
    ...
    /**
     * The consumer method must return true for the task to be created.
     * If it returns false, the message will be ignored, no task created. This can be used to filter out messages.
     */
