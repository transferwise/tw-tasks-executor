...
public interface IToKafkaSenderService {
     ...
     * <p>
     * You can provide an Object in payload and it will be json-serialized or a plain string in payloadString.
     * <p>
     * Note that the implementation doesn't add a namespace to the topic, you need to do this yourself
     * (see for example KafkaHelper in Payout Service).
     * <p>
     * key - kafka message key, usually not needed
     * sendAfterTime - if you want to delay the sending of message
     */
