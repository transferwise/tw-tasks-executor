...
/**
 * A handler similar to {@link KafkaMessageToTaskConverter} but resiliently handling corrupted (failed to deserialize) messages from kafka topic. The
 * decision on how to handle the corrupted message is delegated to {@link CorruptedMessageRecoveryStrategy}.
 */
@Slf4j
