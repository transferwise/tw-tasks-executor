...
public class TasksManagementPortController implements ITasksManagementPort {
  ...
  public MarkTasksAsFailedResponse markTasksAsFailed(@RequestBody MarkTasksAsFailedRequest request) {
    ...
    return new MarkTasksAsFailedResponse().setResults(serviceResponse.getResults().entrySet().stream().collect(
  ...
  public ResumeTasksImmediatelyResponse resumeTasksImmediately(@RequestBody ResumeTasksImmediatelyRequest request) {
    ...
    return new ResumeTasksImmediatelyResponse().setResults(serviceResponse.getResults().entrySet().stream().collect(
        Collectors
  ...
  public GetTasksInErrorResponse getTasksInError(@RequestBody(required = false) GetTasksInErrorRequest request) {
    ...
    return new GetTasksInErrorResponse().setTasksInError(serviceResponse.getTasksInError().stream().map(taskInError ->
  ...
  @Override
  public GetTasksInProcessingOrWaitingResponse getTasksInProcessingOrWaiting(
  ...
  public GetTasksStuckResponse getTasksStuck(@RequestBody(required = false) GetTasksStuckRequest request) {
    ...
    return new GetTasksStuckResponse().setTasksStuck(serviceResponse.getTasksStuck().stream().map(taskStuck ->
